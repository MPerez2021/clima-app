...
import { ClimaServiceService } from './servicios/clima.service';
...
export class AppComponent {
  ...
  constructor(private climaService: ClimaServiceService, private dialog: MatDialog, private paisesService: PaisesService,
